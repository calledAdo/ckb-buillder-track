...
offckb deploy --network devnet --target <contract-binary-path> --output /home/destiny/trial-ckb/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/destiny/trial-ckb/deployment
```
